...
const GetAJob = () => {
  return (
    <>
      ...
      <ul>
        <li>How to <a href="https://dev.to/yuridevat/how-to-write-a-promising-cv-32ih">write a promising CV</a></li>
        <li>How to <a href="https://dev.to/yuridevat/how-to-create-a-stunning-github-profile-2mh5">create a stunning GitHub profile</a></li>
        <li>How to <a href="https://dev.to/yuridevat/how-to-create-a-professional-linkedin-profile-2n11">create an professional LinkedIn Profile</a></li>
      </ul>
      <p>
      ...
      <a href="https://github.com/YuriDevAT/job-seekers/wiki/Checklist-for-your-portfolio-projects">Grab the checklist</a>
      ...
      <a href="https://github.com/YuriDevAT/job-seekers/wiki/Interview-Questions">Interview questions</a>
    </>
  )
}
